...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    let naverUrl = "https://openapi.naver.com/v1/search/image.xml?query="
...
//        }
        ...
        let userQuery = "seoul"//myTextField.text
        ...
        do{
            ...
            if let tempArrays = array["items"] as? NSArray{ // 배열로 변환
                ...
                for tempArray in tempArrays {
                    ...
                    newEvent.setValue(tmp["imagetitle"] as! String, forKey: "imagetitle")
                    newEvent.setValue(tmp["imagelink"] as! String, forKey: "imagelink")
                    //newEvent.setValue(tmp["imageread"] as! String, forKey: "imageread")
    ...
    func configureCell(_ cell: UITableViewCell, withEvent event: Event) {
        cell.textLabel!.text = event.imagetitle!.description
    }
